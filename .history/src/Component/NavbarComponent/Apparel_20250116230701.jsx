...
const Apparel = ({ cartItems, setCartItems }) => {
  ...
  const products = [
    { id: 1, name: "VINTAGE COIRO genuine", price: "300Rs", img: "https://m.media-amazon.com/images/I/51qkAEBj-OL._AC_UY1100_.jpg" },
    { id: 2, name: "Classic T-Shirt", price: "300Rs", img: "https://www.beyoung.in/blog/wp-content/uploads/2018/09/general-1.png" },
    { id: 3, name: "Elegant Dress", price: "300Rs", img: "https://media.shopkund.com/media/catalog/product/cache/9b8fb9a78b48ba20857a65111a93b65e/a/c/acu6404-1-maroon-faux-georgette-embroidered-girls-dress-with-dupatta-gl0072.jpg" },
    ...
    { id: 5, name: "Golden Silk Bridal Saree", price: "300Rs", img: "https://5.imimg.com/data5/MM/TY/WF/SELLER-93705549/golden-silk-bridal-saree.jpg" },
    { id: 6, name: "Modern Shoes", price: "300Rs", img: "https://uathayam.in/cdn/shop/files/LP_5179.jpg?v=1703487105&width=1080" },
    ...
    { id: 8, name: "Women Casual Flats", price: "300Rs", img: "https://5.imimg.com/data5/SELLER/Default/2023/3/292961893/MD/WL/FO/182365761/women-casual-shallow-mouth-shoe-pointed-toe-shoe-working-flat-shoes.jpg" },
  ];
  ...
  const handleBuyNow = (productId) => {
    ...
    if (selectedProduct) {
      ...
      if (!cartItems.find((item) => item.id === selectedProduct.id)) {
        setCartItems([...cartItems, selectedProduct]); // Add to cart
